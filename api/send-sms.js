...
export default async function handler(req, res) {
  ...
  try {
    ...
    const url = `https://control.msg91.com/api/sendhttp.php?authkey=${MSG91_AUTH_KEY}&mobiles=${cleanPhone}&message=${encodeURIComponent(
      message
    )}&sender=${MSG91_SENDER_ID}&route=${MSG91_ROUTE}&country=91`;
